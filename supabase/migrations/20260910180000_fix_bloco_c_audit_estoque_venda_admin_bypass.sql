-- Bloco C: 3 funções lidas e confirmadas vulneráveis já no checkpoint
-- anterior (mesmo padrão has_role(admin) global como bypass de empresa),
-- corrigidas agora:
...
BEGIN
  ...
  v_is_admin := public.has_role(auth.uid(), 'novus_owner');
