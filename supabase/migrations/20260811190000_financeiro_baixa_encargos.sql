-- financeiro_liquidar_titulo: juros, multa e desconto; restante do corpo inalterado.
DROP FUNCTION IF EXISTS public.financeiro_liquidar_titulo(uuid, text, numeric, date, text, uuid, uuid, text, jsonb, uuid);
