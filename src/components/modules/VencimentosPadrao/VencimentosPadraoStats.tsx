...
export const VencimentosPadraoStats: React.FC<VencimentosPadraoStatsProps> = ({
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
      <Card className="border-l-4 border-l-accent-vivid">
        <CardContent className="p-4">
          <div className="flex items-center justify-between">
            ...
            <div className="p-2 bg-accent-vivid-soft rounded-lg">
              <DollarSign className="w-5 h-5 text-accent-vivid" />
            </div>
          </div>
        </CardContent>
      </Card>
      ...
      <Card className="border-l-4 border-l-accent-vivid">
        <CardContent className="p-4">
          <div className="flex items-center justify-between">
            ...
            <div className="p-2 bg-accent-vivid-soft rounded-lg">
              <TrendingUp className="w-5 h-5 text-accent-vivid" />
            </div>
          </div>
        </CardContent>
      </Card>
      ...
      <Card className="border-l-4 border-l-accent-vivid">
        <CardContent className="p-4">
          <div className="flex items-center justify-between">
            ...
            <div className="p-2 bg-accent-vivid-soft rounded-lg">
              <Users className="w-5 h-5 text-accent-vivid" />
            </div>
          </div>
        </CardContent>
      </Card>
