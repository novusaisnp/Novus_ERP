...
export const BancosModal = ({
  ...
  const buscarPorCodigo = async () => {
    ...
    try {
      console.log('[BancoModal] Buscando banco por código:', codigoValue);
      ...
      console.error('[BancoModal] Erro ao buscar por código:', error);
      toast({
        title: 'Erro',
  ...
  const buscarPorNome = async () => {
    ...
    try {
      console.log('[BancoModal] Buscando bancos por nome:', nomeValue);
      ...
      if (bancosEncontrados.length > 0) {
        console.log('[BancoModal] Bancos encontrados:', bancosEncontrados.length);
      ...
      console.error('[BancoModal] Erro ao buscar por nome:', error);
      toast({
        title: 'Erro',
  ...
  const selecionarBanco = (bancoSelecionado: any) => {
    console.log('[BancoModal] Banco selecionado:', bancoSelecionado);
  ...
  const handleFormSubmit = (data: BancoInput) => {
    console.log('[BancoModal] Submetendo formulário:', data);
    onSubmit(data);
  };
