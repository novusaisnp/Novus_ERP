...
import { BancosHeader } from '@/components/financeiro/bancos/BancosHeader';
import { BancosStats } from '@/components/financeiro/bancos/BancosStats';
import { BancosFilters } from '@/components/financeiro/bancos/BancosFilters';
import { BancosContent } from '@/components/financeiro/bancos/BancosContent';
import { BancosModal } from '@/components/financeiro/bancos/BancosModal';
import { Banco, BancoInput } from '@/types/banco';

console.log('[Bancos] Página de bancos carregada');
...
const Bancos = () => {
  ...
  const handleFilter = (novosFiltros: typeof filtros) => {
    console.log('[Bancos] Aplicando filtros:', novosFiltros);
    setFiltros(novosFiltros);
  };

  if (error) {
    console.error('[Bancos] Erro ao carregar página:', error);
    return (
